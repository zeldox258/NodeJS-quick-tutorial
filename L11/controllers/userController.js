...
const getOneTimeAccessToken = async (req, res) => {
   try {
...
module.exports = { register, login, getUserDetails, updatePassword, refreshToken, cleanBlacklist, logout, getOneTimeAccessToken, getAllUserDetails };